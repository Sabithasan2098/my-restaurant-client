...
const Footer = () => {
  return (
    <div className="max-w-[1920px] mx-auto text-white mt-[130px]">
      <div className="flex items-center h-[400px] ">
        <div className="bg-[#1F2937]  h-full flex-1 relative">
          <div className="flex flex-col w-[345px] top-[97px] items-center absolute left-[457px]">
            <h1 className="uppercase text-[32px] font-medium pb-6">
              contact us
            </h1>
        ...
        <div className=" bg-[#111827] h-full flex-1 relative">
          <div className="flex flex-col w-[345px] top-[97px] items-center absolute right-[457px]">
            <h1 className="text-[32px]  font-medium pb-6">Follow Us</h1>
            <p className="text-[20px] leading-[36px] font-medium">
      ...
      <p className="bg-[#151515] py-[17px] flex justify-center">
