...
const Footer = () => {
  return (
    <div className="max-w-[1920px] mx-auto text-white mt-[30px] md:mt-[50px] lg:mt-[130px]">
      <div className="flex items-center h-[170px] md:h-[250px] lg:h-[400px] ">
        <div className="bg-[#1F2937]  h-full flex-1 relative">
          <div className="flex flex-col lg:w-[345px] md:top-[30px] lg:top-[97px] items-center absolute md:left-[97px] lg:left-[457px] py-5">
            <h1 className="uppercase text-[18px] md:text-[24px] lg:text-[32px] font-medium pb-2 md:pb-[14px] lg:pb-6">
              contact us
            </h1>
            <p className="text-[12px] md:text-[16px] text-center lg:text-[20px] lg:leading-[36px] lg:font-medium">
        ...
        <div className=" bg-[#111827] h-full flex-1 relative">
          <div className="flex flex-col lg:w-[470px] md:top-[30px] lg:top-[97px] items-center absolute md:left-[97px] lg:right-[457px] left-8 py-5">
            <h1 className="text-[18px] md:text-[24px] lg:text-[32px]  lg:font-medium pb-2 md:pb-[14px] lg:pb-6">
              Follow Us
            </h1>
            <p className="text-[12px] md:text-[16px] text-center lg:text-[20px] lg:leading-[36px] font-medium">
              Join us on social media
            </p>
            <div className="pt-2 md:pt-4 lg:pt-8 flex  items-center gap-2 md:gap-4 lg:gap-8">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 35 35"
                fill="none"
                className="w-5 h-5 md:w-7 md:h-7 lg:w-10 lg:h-10 fill-white"
              >
                <path
      ...
      <Link href={"https://sabit-portfolio-qq44.vercel.app/"}>
        <p className="bg-[#151515] py-[7px] md:py-[12px] lg:py-[17px] flex justify-center custom-text text-[16px] md:text-[22px] lg:text-[26px] font-medium md:font-semibold ">
          Developer: @ S a b i t H a s a n
        </p>
      </Link>
    </div>
  );
